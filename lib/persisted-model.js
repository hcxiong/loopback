...
PersistedModel.setupRemoting = function() {
  ...
  var idType = this._getRemotingIdType(this);
  ...
  setRemoting(PersistedModel, 'exists', {
    ...
    accessType: 'READ',
    accepts: {arg: 'id', type: idType, description: 'Model id', required: true},
  ...
  setRemoting(PersistedModel, 'findById', {
    ...
    accessType: 'READ',
    accepts: {
      arg: 'id', type: idType, description: 'Model id', required: true,
      http: {source: 'path'}
    },
    returns: {arg: 'data', type: typeName, root: true},
  ...
  if (options.trackChanges) {
    ...
    setRemoting(PersistedModel, 'rectifyChange', {
      ...
      accessType: 'WRITE',
      accepts: {arg: 'id', type: idType, http: {source: 'path'}},
